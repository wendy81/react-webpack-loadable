		...
		return (
			<svg width={width} height={height} viewBox="0 0 140 140" version="1.1" >
				...
				<g id="Icons" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
					<g transform="translate(-1886.000000, -285.000000)" fillRule="nonzero" id="icon_Excel">
						<g transform="translate(1898.000000, 285.000000)">
							<g id="Group" fill="url(#linearGradient-1)">
								<rect id="矩形_562_拷贝-2" x="0" y="0" width="115.294118" height="140" rx="4"></rect>
							</g>

...
render(){
    ...
    return (
        <svg width={width} height={height} viewBox="0 0 140 140" version="1.1" style={{transform: 'rotate(180deg)'}}>
		    <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
		        <g id="Desktop-HD" transform="translate(-436.000000, -21.000000)" fill={color} fillRule="nonzero">
		            <g id="right" transform="translate(478.000000, 21.000000)">
